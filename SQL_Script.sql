...
DROP TABLE IF EXISTS soil_info;

DROP TABLE IF EXISTS medical_incident_documents;

DROP TABLE IF EXISTS houses;

DROP TABLE IF EXISTS mates_with;

DROP TABLE IF EXISTS researches;

DROP TABLE IF EXISTS organism_belongs_to;

DROP TABLE IF EXISTS species;

DROP TABLE IF EXISTS researcher_topic;

DROP TABLE IF EXISTS researcher_name;

DROP TABLE IF EXISTS research_info;

DROP TABLE IF EXISTS habitat_coord;
...
DROP TABLE IF EXISTS habitat_temp;

DROP TABLE IF EXISTS habitat_biome;

DROP TABLE IF EXISTS ranger_experience;

DROP TABLE IF EXISTS ranger_age;

DROP TABLE IF EXISTS ranger_number;
...
INSERT INTO
  species (scientific_name, common_name, endangered_status)
VALUES
...
INSERT INTO
  organism_belongs_to (sex, age, species_name)
VALUES
  ('M', 8, 'Panthera leo'),
  ('F', 5, 'Panthera leo'),
  ('M', 3, 'Panthera leo'),
...
INSERT INTO
  soil_info (is_evergreen, soil_type)
VALUES
  (TRUE, 'Loamy'),
  (FALSE, 'Clay'),
  (TRUE, 'Sandy'),
...
INSERT INTO
  plant_soil (soil_type, organism_tag)
VALUES
  ('Loamy', 11),
  ('Sandy', 12),
  ('Loamy', 13),
...
INSERT INTO
  research_info (research_topic, department)
VALUES
...
INSERT INTO
  researcher_topic (id, research_topic)
VALUES
...
INSERT INTO
  region (code_name, name, continent)
VALUES
  ('SAH', 'Sahara', 'AF'),
  ('GBS', 'Great Basin', 'NA'),
  ('KNP', 'Kalahari', 'AF'),
...
INSERT INTO
  habitat_temp (temperature, containing_region)
VALUES
  (30.5, 'SAH'),
  (15.3, 'GBS'),
  (24.8, 'KNP'),
...
INSERT INTO
  habitat_biome (biome, containing_region)
VALUES
  ('Desert', 'SAH'),
  ('Desert', 'GBS'),
  ('Desert', 'KNP'),
...
INSERT INTO
  habitat_coord (x_coord, y_coord, containing_region)
VALUES
  (45.12, -75.34, 'SAH'),
  (50.45, -100.23, 'GBS'),
  (39.99, -104.89, 'KNP'),
...
INSERT INTO
  ranger_certification (experience, certification_level)
VALUES
  ('Novice', 1),
  ('Apprentice', 2),
  ('Journeyman', 3),
...
INSERT INTO
  ranger_experience (badge_number, certification_level)
VALUES
  (1, 1),
  (2, 1),
  (3, 1),
...
INSERT INTO
  project_status (start_date, end_date, status)
VALUES
  ('2024-03-20', '2025-12-31', 'Ongoing'),
...
INSERT INTO
  project_info (operation_name, budget, start_date, end_date)
VALUES
  (
  ...
  (
    'Desert Jaguar Monitoring',
    2000000,
    '2024-05-13',
    '2027-06-17'
  ),
  (
    'Bactrian Camel Protection Program',
    800000,
    '1994-03-21',
    '2010-02-19'
  );
...
INSERT INTO
  donor (name, email, address, affiliation)
VALUES
  (
    'Elon Musk',
  ...
  (
    ...
    '101 Cedar Ln, Greenwood',
    'Rainforest Rescue'
  ),
  (
    'James Davis',
    'james.davis@example.com',
    '202 Birch Dr, Meadowbrook',
    'Save the Whales'
  ),
  (
    'Olivia Martinez',
  ...
  (
    ...
    '404 Willow Blvd, Hillcrest',
    'Forest Alliance'
  ),
  (
    'Ava Rodriguez',
    'ava.rodriguez@example.com',
    '505 Poplar Ave, Bayside',
    'Nature Conservancy'
  ),
  (
    'Ethan Hernandez',
    'ethan.hernandez@example.com',
    '606 Cypress Ct, Mountain View',
    'Forest Alliance'
  ),
  (
    'Isabella Wilson',
    'isabella.wilson@example.com',
    '707 Redwood Ter, Valley Heights',
    'World Wildlife Trust'
  );

INSERT INTO
  medical_incident_documents (disease_name, incident_date, organism_tag)
VALUES
  ('Rabies', '2023-04-12', 1),
  ('Rabies', '2023-03-11', 2),
  ('Rabies', '2023-01-21', 4),
...
INSERT INTO
  donates (amount, donor_id, project_operation_name)
VALUES
  (250000, 1, 'Reforestation Initiative'),
...
INSERT INTO
  protects (project_operation_name, region_code_name)
VALUES
  ('Reforestation Initiative', 'AMZ'),
...
INSERT INTO
  houses (organism_tag, habitat_x_coord, habitat_y_coord)
VALUES
  (1, 45.12, -75.34),
  (2, 50.45, -100.23),
  (3, 39.99, -104.89),
...
INSERT INTO
  monitors (region_code_name, ranger_badge_number)
VALUES
  ('SAH', 1),
  ('GBS', 2),
  ('KNP', 3),
...
INSERT INTO
  mates_with (female_organism_tag, male_organism_tag)
VALUES
  (2, 1),
  (2, 3),
  (10, 9),
...
INSERT INTO
  researches (researcher_id, organism_tag)
VALUES
  (1, 10),
  (2, 9),
  (3, 8),
